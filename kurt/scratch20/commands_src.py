...
commands = [
    ...
    ['switch backdrop to %m.backdrop and wait',
     ' ', 102, 'startSceneAndWait', 'backdrop1'],
    ['next backdrop', ' ', 102, 'nextScene'],
    ['-'],
    ['change %m.effect effect by %n', ' ', 102,
     'changeGraphicEffect:by:', 'color', 25],
    ['set %m.effect effect to %n', ' ', 102,
    ...
    ['-'],
    ['play note %d.note for %n beats', ' ', 3,
    ...
    ['when backdrop switches to %m.backdrop',
     'h', 5, 'whenSceneStarts', 'backdrop1'],
    ['--'],
    ['when %m.triggerSensor > %n', 'h', 5,
    ...
    ['-'],
    ['video %m.videoMotionType on %m.stageOrThis', 'r',
     107, 'senseVideoMotion', 'motion', 'Stage'],
    ...
    ['play drum %n for %n beats', ' ', 98,
        'drum:duration:elapsed:from:', 1, 0.2],
    ...
    ['switch to background %m.costume', ' ',
        98, 'showBackground:', 'backdrop1'],
